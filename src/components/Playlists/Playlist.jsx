...
class Playlist extends Component {
  constructor(props) {
    super(props);
    if (new.target === Playlist) {
      throw new TypeError('Cannot construct Playlist instances directly');
    }
  }
  ...
  render() {
    ...
    return (
      <Card key={this.title} mt={2} ml={2} mr={2} mb={4} bgColor={'#edf2f7'} boxShadow={'md'} minW={isMobile ? 0:500} maxW={500}>
        <CardHeader>
          <HStack>
